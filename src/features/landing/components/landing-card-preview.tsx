...
export function LandingCardPreview() {
  return (
    <ScrollReveal>
      ...
      >
        <div className="brutal-card rotate-1 bg-accent-blue p-5 split-card-left">
        ...
        <div className="brutal-card -rotate-1 bg-accent-yellow p-5 split-card-center">
        ...
        <div className="brutal-card rotate-1 bg-paper-base p-5 split-card-right">
